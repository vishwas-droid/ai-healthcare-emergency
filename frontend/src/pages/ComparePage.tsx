  ...
  return (
    <section>
      ...
      <div className="mt-4 grid gap-3 rounded-2xl bg-white p-4 shadow-premium sm:grid-cols-5">
        ...
        <input value={city} onChange={(e) => setCity(e.target.value)} placeholder="City" className="rounded-lg border px-3 py-2" />
        <input value={category} onChange={(e) => setCategory(e.target.value)} placeholder="Problem/Category" className="rounded-lg border px-3 py-2" />
        <input value={budget} onChange={(e) => setBudget(e.target.value)} placeholder="Budget" className="rounded-lg border px-3 py-2" />
      </div>
